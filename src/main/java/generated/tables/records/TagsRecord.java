...
public class TagsRecord extends UpdatableRecordImpl<TagsRecord> implements Record4<Integer, Time, String, Integer> {

	private static final long serialVersionUID = -499056071;
	 ...
	 */
	@Override
	public TagsRecord values(Integer value1, Time value2, String value3, Integer value4) {
		value1(value1);
		value2(value2);
		value3(value3);
		value4(value4);
	 ...
	 */
	public TagsRecord(Integer id, Time uploaded, String tag, Integer receiptid) {
		super(Tags.TAGS);
